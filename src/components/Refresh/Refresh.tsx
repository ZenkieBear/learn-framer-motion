// This component from https://codesandbox.io/s/framer-motion-transition-prop-j9m7d2?
...
export const Refresh = ({ onClick }: { onClick: React.MouseEventHandler }) => {
  return (
    <motion.div
      className={clsx(styles.refresh, 'refresh')}
      onClick={onClick}
      variants={button}
      initial='rest'
      whileHover='hover'
